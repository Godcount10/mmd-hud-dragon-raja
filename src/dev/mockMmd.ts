  ...
  root.innerHTML = `
    ...
    <div class="native-card">
      ...
      <div id="msglistview">
        ...
        <div class="item Ai"><div class="touch-scope" id="item-a2"><div class="content left" id="q-mock-a2"><p>夜风掠过天台，霓虹在远处铺开。</p><p>[时间=21:30][角色1姓名=楚子航][角色1身份=狮心会会长][角色1关系=执行专员][角色1血统=A级 / 高危躁动][角色1言灵=序列89·君焰][角色1装备=妖刀·村雨、美瞳][角色1特质=龙血副作用(黄金瞳无法熄灭)、奥丁印记][角色1描述=永远面瘫的杀胚师兄，背着网球包，里面藏着村雨。][角色1台词=这里不是普通学生该来的地方，立刻回学院。][角色1我方台词=好啦好啦，师兄总是这么死板。][角色1侧写=永不熄灭的黄金瞳，只为一人燃起。][角色2姓名=夏弥][角色2身份=卡塞尔学院新生][角色2关系=暗中观察的龙王][角色2血统=S级 / 稳定 (伪装)][角色2言灵=序列112·风王之瞳 (伪装)][角色2装备=暂无][角色2特质=疑似拥有次代种以上级别的龙脉力量][角色2描述=穿着亮蓝色的露肩折褶裙，盘腿坐在天台的机箱上。][角色2台词=师兄，这么晚了还在出任务啊？][角色2我方台词=你在这种地方做什么？][角色2侧写=世界那么大，我想去看看。][好感度=18][地点=芝加哥天台][选项1标题=开启黄金瞳威慑][选项1=你直接点燃了黄金瞳，炽热的龙威瞬间爆发。][选项2标题=坐下来聊聊套情报][选项2=你沉默片刻，走到她身边隔着一段距离坐下。][选项3标题=强行带她离开][选项3=你上前一步，语气不容置疑：立刻跟我走。][头条1=震惊！听说今天有个新进来的Lv.1见习追书人带了整整十万初始积分？！][头条2=【置顶】芝加哥高层公寓突发能量波动调查报告][头条3=有人看到狮心会会长带着网球包出门了吗？][帖子作者=@爆料达人][帖子正文=震惊！听说今天有个新进来的Lv.1见习追书人带了整整十万初始积分？！][回复1昵称=吃瓜群众][回复1=真的假的？十万？我攒了三个副本才五千！][回复2昵称=机械飞升][回复2=假的吧，初始积分不是上限一千吗？][回复3昵称=神奇海豹][回复3=本海豹亲眼所见！是真的金主大爷！]</p></div><div class="modify-btn-scope"><button class="modify-btn" type="button">重新生成</button><button class="modify-btn" type="button">编辑</button><button class="modify-btn" type="button">分享</button></div></div></div>
      </div>
