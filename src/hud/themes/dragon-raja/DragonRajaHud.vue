...
<template>
  <main class="dragon-raja-hud">
    ...
    <LocalMenu v-if="menuOpen" :statuses="statuses" :refresh-pending="refreshConversationPending" @close="menuOpen = false" @settings="requestSurface('settings'); menuOpen = false" @archives="handleLocalAction('archives')" @persona="handleLocalAction('persona')" @supplement="handleLocalAction('supplement')" @models="handleLocalAction('models')" @refresh="handleLocalAction('refresh')" @exit="handleLocalAction('exit')" />
